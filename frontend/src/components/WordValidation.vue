...
export default {
  ...
  methods: {
    ...
    validateWord(playerId) {
      ...
      if (
        this.completeWord === this.guessedWord ||
        this.validLetters.length === this.uniqueLetters.length
      ) {
        this.winner = player;
        ...
        if (player == this.players[0]) {
          ...
          //if the second player guessed wrong, first player wins
